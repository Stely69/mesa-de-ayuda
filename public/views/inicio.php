...
<body class="bg-white">
        ...
        <div class="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <div id="menu" class="hidden md:flex flex-col md:flex-row md:items-center gap-4 absolute md:static top-16 left-0 w-full md:w-auto bg-[#39A900] md:bg-transparent px-6 md:px-0 py-4 md:py-0 shadow-md md:shadow-none">
                <div class="flex flex-col md:flex-row gap-4">
                    ...
                    <a href="Login/inicio_sesion" class="bg-white text-[#39A900] px-4 py-2 rounded-full font-semibold hover:bg-gray-100 transition duration-200 text-center">Iniciar Sesión</a>
                </div>
            </div>
        </div>
    </nav>
    ...
    <!-- Hero Section -->
    <section id="hero" class="flex flex-col-reverse md:flex-row items-center justify-center text-center md:text-left p-6 md:p-16 mt-24 gap-8">
        <!-- Imagen -->
    ...
    <section id="how-it-works" class="bg-gray-50 px-6 py-12 md:px-16 text-center">
    ...
    <!-- Team Section -->
    <section id="team" class="bg-gray-50 px-6 py-12 md:px-16 text-center">
