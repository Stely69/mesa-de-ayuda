        ...
        <main class="flex-1 p-6 md:ml-64 overflow-auto pt-16">
            ...
            <div class="bg-white p-4 shadow rounded-md mb-4">
                ...
                <div class="flex flex-col md:flex-row md:space-x-4 space-y-2 md:space-y-0">
                    <select id="filtroAmbiente" class="p-2 border rounded-md w-full md:w-auto">
                        <option value="">Todos los Ambientes</option>
                        <option value="Aula 101">Aula 101</option>
                        <option value="Aula 102">Aula 102</option>
                        <option value="Aula 103">Aula 103</option>
                    </select>
                    <select id="filtroEstado" class="p-2 border rounded-md w-full md:w-auto">
                        <option value="">Todos los Estados</option>
                        <option value="Agregado">Agregado</option>
                        <option value="Eliminado">Eliminado</option>
                        <option value="Modificado">Modificado</option>
                    </select>
                    <button onclick="filtrarHistorial()" class="bg-[#39A900] text-white p-2 rounded-md w-full md:w-auto">
                        Aplicar Filtro
                    </button>
                </div>
            </div>
